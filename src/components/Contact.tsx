            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  ...
                  size="lg"
                  className="font-bold"
                  onClick={() => window.open(`https://wa.me/254755659443?text=${whatsappMessage}`, '_blank')}
                >
                ...
                <Button 
                  ...
                  onClick={() => window.open('tel:+254755659443')}
                >
